				...
				<div class="row-fluid ">
					<div class="span12">
						<div class="content-widgets light-gray">
							...
							<form action="${pageContext.request.contextPath}/admin/order/dobuy" method="post">
							...
							<div class="control-group">
								<label for="title" class="control-label">供应商：</label>
								<div class="controls">
							...
							<div class="control-group">
								...
								<div class="modal-footer center" id="div_footer">
									<button type="submit" class='btn btn-primary'>商品入库</button>
								</div>
						</form>
							</div>
						</div>
